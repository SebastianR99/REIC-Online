                            ...
                            <div class="contact-form" >
                                ...
                                @csrf
                                    <div class="form-group" >
                                        <textarea id='content' name='content' class="form-control" placeholder="Redacta tu observación" required="required" ></textarea>
                                        <input id='user_id' name='user_id' type='hidden' value='{{$arreglo['user_id']}}'> 
                                        <input id='title_id' name='title_id' type='hidden' value='{{$arreglo['titulo']}}'> 
                                    </div>
                                    <div>
