...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            ...
            <?php
            $contador = 1;
            foreach($arrayObservations as $key => $observation)
            {
                       ...
                       echo '<div class="timeline-start">';
                            if($contador == 1)
                            {
                                ...
                                echo '<div class="timeline-content">';
                                      ...
                                      echo  '<h2>' .$observation->name.'</h2>';
                                      echo  '<h2>' .$observation->title_name.'</h2>';
                                        echo '<p>';
                                          echo $observation->observation_content;
                                        echo '</p>';
                                echo '</div>';
                                echo '</div>';
                                $contador-=1;
