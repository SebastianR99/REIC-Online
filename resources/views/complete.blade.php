            ...
            <div class="single">
                <div class="container">
                    <div class="section-header">
                        <h2>Ley 842 de 2003 </h2>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <img class="img-fluid rounded" src="{{ url('/assets/img/ley.jpg') }}" alt="Image">
                            <div class="contact">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="contact-form">
                                            ...
                                            @csrf
                                                ...
                                                <label for='busqueda'>Elige un criterio para la busqueda: </label>
                                                <select id='busqueda' name='busqueda'>
                                                    ...
                                                    <option value='4'>PALABRA</option>
                                                </select>
                                                <input type='text' id='content' name='content'> 
                                                </div>
                                                <div>
                                                    <button class="btn" type="submit">Enviar Busqueda</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            {
                                if($titulo_antes == $titulo->title_name)
                                {
                                ...
                                elseif($titulo_antes != $titulo->title_name)
                                {
                                    echo '<h1>'.$titulo->title_name .'</h1>';
                                    if($capitulo_antes == $titulo->chapter_name)
                                    {
                                        if($titulo->title_id == 2)
                                        {
                                            echo '<h2> CAPITULO I: REQUISITOS PARA EJERCER LA INGENIERÍA, SUS PROFESIONES AFINES Y SUS PROFESIONES AUXILIARES </h2>';                                        }
                                        echo '<h5>'.$titulo->article_name .'</h5>';
                                        echo '<p>'.$titulo->article_content.'</p>';
                                    }
                                    elseif($capitulo_antes != $titulo->chapter_name)
                                ...
                                $titulo_antes = $titulo->title_name;
                    ...
                    <div>
                <div class="views-element-container"><div class="comp-contextual-menu js-view-dom-id-f4e11f2baa7eeabf63a3012c375f69231bbeb18ef0e4fa6f1570f248af2e3a8e">
</div>
</div>
</div>
