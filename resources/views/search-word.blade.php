                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            {
                                echo '<h1>'.$search->title_name.': '.$search->title_des.'</h1>';
                                echo '<h2>'.$search->chapter_name.': '.$search->chapter_des.'</h2>';
                                echo '<h5>'.$search->article_name,'</h5>';
                                echo '<p>'.$search->article_content.'</p>';
                                echo '<br>';
